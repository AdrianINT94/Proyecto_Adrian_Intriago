...
public class TutorEmpresaController {
    ...
    @GetMapping("/{id}")
    public TutorEmpresa getTutorEmpresaById(@PathVariable Integer id) {
    ...
    @PutMapping("/{id}")
    public TutorEmpresa updateTutorEmpresa(@PathVariable Integer id, @RequestBody TutorEmpresa tutorEmpresaDetails) {
    ...
    @DeleteMapping("/{id}")
    public void deleteTutorEmpresa(@PathVariable Integer id) {
